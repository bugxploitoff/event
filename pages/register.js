...
import { getAuth, createUserWithEmailAndPassword, sendEmailVerification } from "../utils/util";
import { firebaseConfig } from "../utils/util"; // Your Firebase configuration
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="An event ticketing system built with Next.js and Firebase"
        />
